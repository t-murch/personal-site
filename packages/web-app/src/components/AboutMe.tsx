export function AboutMe() {
  return (
    <div className="flex flex-col gap-2">
      <p className="text-lg">
        A software developer with 3+ years of experience based in Austin, TX. I
        ...
        <br />
        Projects section coming soon, happy to discuss while still in
        development.
      </p>{" "}
      <span>
        Currently seeking opportunities! Reach out on
        <a
